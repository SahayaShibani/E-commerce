...
onClose,
  ...
  fetchData
    ...
    const handleSubmit = async (e) => {
        ...
        const uploadresponse = await fetch("https://e-commerce-backend-c2it.onrender.com/api/update-product", {
            method: "post",
            credentials: "include",
            headers: {
        ...
        <div className="fixed upload-product bg-slate-200 bg-opacity-35 w-full h-full top-0 left-0 right-0 bottom-0 flex justify-center items-center">
            <div className="bg-white p-4 rounded w-full max-w-2xl h-full max-h-[80%] overflow-hidden">
                ...
                <form className="grid p-4 gap-3 overflow-y-scroll h-full pb-20" onSubmit={handleSubmit}>
                    ...
                    <button className="px-3 py-1 upload-btn text-white mb-10" type="submit">Update Product</button>
                </form>
